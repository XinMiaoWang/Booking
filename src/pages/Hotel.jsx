...
import { faPeopleGroup, faLocationDot, faHeartCircleCheck, faWifi, faSmokingBan } from '@fortawesome/free-solid-svg-icons'
                ...
                <div className="HotelWrapper">
                    ...
                    <div className="hotelTitle">
                        <div className="titleLeft">
                            ...
                            <span className="recommand">
                                <span className="recommandSvg">
                            ...
                            <div className="address">
                                ...
                                台南中西區No. 28 Dade Street <a>地理位置超棒－顯示地圖</a>
                            </div>
                        </div>
